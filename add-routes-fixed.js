        ...
        for (const route of routes) {
            ...
            try {
                ...
                if (error.code === 'ER_DUP_ENTRY') {
                    console.log(`ℹ️ Route ${route.from_location} to ${route.to_location} already exists, skipping...`);
                } else {
                    console.error(`❌ Error adding route ${route.from_location} to ${route.to_location}:`, error.message);
                }
            }
        }
